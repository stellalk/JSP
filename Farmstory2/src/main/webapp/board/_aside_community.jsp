...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
 <div id="sub">
     ...
     <section class="cate5">
         <aside>
             <img src="/Farmstory2/img/sub_aside_cate5_tit.png" alt="community"/>
         ...
         <article>
             <nav>
             <c:if test="${cate eq 'notice'}"><img src="/Farmstory2/img/sub_nav_tit_cate5_tit1.png" alt=""/></c:if>
             <c:if test="${cate eq 'menu'}"><img src="/Farmstory2/img/sub_nav_tit_cate5_tit2.png" alt=""/></c:if>
             <c:if test="${cate eq 'chef'}"><img src="/Farmstory2/img/sub_nav_tit_cate5_tit3.png" alt=""/></c:if>
             <c:if test="${cate eq 'qna'}"><img src="/Farmstory2/img/sub_nav_tit_cate5_tit4.png" alt=""/></c:if>
             <c:if test="${cate eq 'faq'}"><img src="/Farmstory2/img/sub_nav_tit_cate5_tit5.png" alt=""/></c:if>
