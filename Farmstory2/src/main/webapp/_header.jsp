...
<body>
    <div id="wrapper">
        <header>
            <a href="/Farmstory2/" class="logo"><img src="/Farmstory2/img/logo.png" alt="logo"/></a>
            <p>
                <a href="/Farmstory2/">HOME |</a>
                
                <c:choose>
                	<c:when test="${empty user}">
                		<a href="/Farmstory2/user/login.do">LOGIN |</a>
               	 		<a href="/Farmstory2/user/terms.do">JOIN |</a>
                	</c:when>
                	<c:otherwise>
                		<a href="/Farmstory2/user/logout.do">LOGOUT |</a>
                	</c:otherwise>
                </c:choose>
